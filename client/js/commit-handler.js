...
var commitHandler = {
    ...
    palettes: {
        ...
        'craft': ['#BD2A4E', '#654B6B', '#628179', '#899738', '#34AB1A', '#8CB6A9', 
            '#396ACC', '#A82A54', '#C29819', '#244844', '#AFA689', '#E5A600', '#F03737', 
            '#CC9C0A', '#E4444C'],
        'fire': ['#FCE138', '#FBDB34', '#FAD531', '#F9CF2E', '#F9C92B', '#F8C328', 
            '#F7BD25', '#F6B722', '#F6B11F', '#F5AB1B', '#F4A518', '#F39F15', '#F39912', 
            '#F2930F', '#F18D0C'],
        'green': ['#AAF22F', '#A6ED2C', '#A2E929', '#9EE426', 
